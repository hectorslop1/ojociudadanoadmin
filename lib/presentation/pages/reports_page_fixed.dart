...
class _ReportsPageState extends State<ReportsPage>
  ...
  Widget _buildReportCard(Report report) {
    ...
    if (report.category == ReportCategory.roadRepair) {
      priority = 'Alta';
      priorityColor = const Color(0xFFE53935); // Rojo
    } else if (report.category == ReportCategory.streetImprovement) {
      priority = 'Media';
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildStatusOption(report, ReportStatus.pending, 'Abierto'),
            _buildStatusOption(report, ReportStatus.assigned, 'Asignado'),
            _buildStatusOption(report, ReportStatus.inProgress, 'En Progreso'),
            _buildStatusOption(report, ReportStatus.resolved, 'Resuelto'),
            _buildStatusOption(report, ReportStatus.rejected, 'Rechazado'),
          ],
        ),
        actions: [
          TextButton(
